class LandingPagesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @landing_page.save
        format.html { redirect_to landing_page_url(@landing_page), notice: "Landing page was successfully created." }
  ...
  def update
    respond_to do |format|
      if @landing_page.update(landing_page_params)
        format.html { redirect_to landing_page_url(@landing_page), notice: "Landing page was successfully updated." }
  ...
  private
    ...
    def landing_page_params
      params.require(:landing_page).permit(:title)
    end
end
